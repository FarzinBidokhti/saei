    ...
    <div class="row align-items-center w-100 gx-0">
        <div class="col-xl-4 col-lg-5 col-md-6 col-sm-4 col-3">
            <div class="app-header-left d-flex align-items-center">
                <button class="app-header-bar-btn app-sidebar-open-btn me-4 d-none d-xl-inline-block"
                    type="button">
                    <span>
                    </span>
                    <span>
        ...
        <div class="col-xl-8 col-lg-7 col-md-6 col-sm-8 col-9">
            <ul class="navbar-nav flex-row align-items-center justify-content-end">
                ...
                <li class="header-nav-item header-style-switcher me-2">
                    <a class="header-nav-link" data-bs-toggle="dropdown" href="javascript:void(0);">
                        ...
                        <span class="d-flex align-items-center justify-content-center theme-icon dark-icon">
                            <svg fill="none" height="15" viewbox="0 0 14 15" width="14"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li>
                            <a class="dropdown-item d-flex align-items-center gap-2"
                                data-bs-theme-value="light" href="javascript:void(0);">
                                <span>
                        ...
                        <li>
                            <a class="dropdown-item d-flex align-items-center gap-2"
                                data-bs-theme-value="dark" href="javascript:void(0);">
                                <span>
                                    <svg fill="none" height="15" viewbox="0 0 14 15" width="14"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                        ...
                        <li>
                            <a class="dropdown-item d-flex align-items-center gap-2"
                                data-bs-theme-value="auto" href="javascript:void(0);">
                                <span>
                                    <svg fill="none" height="13" viewbox="0 0 15 13" width="15"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                ...
                <li class="header-nav-item header-user me-2">
                    <a class="header-nav-link" data-bs-toggle="dropdown" href="javascript:void(0);">
                        <img alt="" class="rounded-circle" height="34" src="{{ asset('assets/img/avatar/10.jpg') }}"
                            width="34" />
                    </a>
                    <div class="dropdown-menu dropdown-menu-end dropdown-menu-lg py-0">
                        ...
                        <div class="dropdown-body py-1">
                            <ul class="list-unstyled dropdown-list">
                                <li>
                                    <a class="dropdown-item fz-14px d-flex align-items-center gap-2 px-5"
                                        ...
                                        <svg fill="none" height="16" viewbox="0 0 17 16" width="17"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path d="M5.573 9.65393H10.767M5.573 5.94393H8.17"
                                                stroke="currentColor" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-width="1.5">
                                            </path>
                                            <path
                                                d="M9.78059 14.3958C12.8844 14.1895 15.3567 11.6821 15.5601 8.53423C15.6 7.91822 15.6 7.28029 15.5601 6.66428C15.3567 3.51645 12.8844 1.00906 9.78059 0.802737C8.72169 0.732349 7.61615 0.732493 6.55941 0.802737C3.45562 1.00906 0.983291 3.51645 0.779858 6.66428C0.740047 7.28029 0.740047 7.91822 0.779858 8.53423C0.853951 9.6807 1.36099 10.7422 1.95791 11.6386C2.3045 12.2661 2.07576 13.0493 1.71476 13.7334C1.45446 14.2266 1.32431 14.4733 1.42881 14.6514C1.53331 14.8296 1.76673 14.8353 2.23357 14.8467C3.1568 14.8691 3.77935 14.6074 4.27352 14.243C4.55379 14.0363 4.69393 13.933 4.79051 13.9211C4.8871 13.9092 5.07717 13.9875 5.45725 14.1441C5.79887 14.2847 6.19551 14.3716 6.55941 14.3958C7.61615 14.466 8.72169 14.4662 9.78059 14.3958Z"
                                ...
                                <li>
                                    <a class="dropdown-item fz-14px d-flex align-items-center gap-2 px-5"
                                        ...
                                        <svg fill="none" height="15" viewbox="0 0 14 15" width="14"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M6.92999 7.25C8.72492 7.25 10.18 5.79493 10.18 4C10.18 2.20507 8.72492 0.75 6.92999 0.75C5.13507 0.75 3.67999 2.20507 3.67999 4C3.67999 5.79493 5.13507 7.25 6.92999 7.25Z"
                                                stroke="currentColor" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-width="1.5">
                                            </path>
                                            <path
                                                d="M13.11 13.75C12.6902 12.4408 11.8655 11.2988 10.7548 10.4886C9.64409 9.6784 8.3048 9.24182 6.93 9.24182C5.5552 9.24182 4.21591 9.6784 3.10522 10.4886C1.99453 11.2988 1.16982 12.4408 0.75 13.75H13.11Z"
                                                stroke="currentColor" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-width="1.5">
                                            </path>
                                        </svg>
                                ...
                                <li>
                                    <a class="dropdown-item fz-14px d-flex align-items-center gap-2 px-5"
                                        href="user-settings-billing.html">
                                        <svg fill="none" height="16" viewbox="0 0 19 16" width="19"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M0.75 7.55C0.75 4.54314 0.75 3.03971 1.64488 2.03596C1.78801 1.87542 1.94576 1.72695 2.11634 1.59224C3.18281 0.75 4.78021 0.75 7.975 0.75H10.525C13.7198 0.75 15.3172 0.75 16.3837 1.59224C16.5542 1.72695 16.712 1.87542 16.8551 2.03596C17.75 3.03971 17.75 4.54314 17.75 7.55C17.75 10.5569 17.75 12.0603 16.8551 13.064C16.712 13.2246 16.5542 13.373 16.3837 13.5078C15.3172 14.35 13.7198 14.35 10.525 14.35H7.975C4.78021 14.35 3.18281 14.35 2.11634 13.5078C1.94576 13.373 1.78801 13.2246 1.64488 13.064C0.75 12.0603 0.75 10.5569 0.75 7.55Z"
                                                stroke="currentColor" stroke-linecap="round"
                                                stroke-linejoin="round" stroke-width="1.5">
                                            </path>
                                            <path d="M7.54993 10.9501H8.82493" stroke="currentColor"
                                                stroke-linecap="round" stroke-linejoin="round"
                                                stroke-miterlimit="10" stroke-width="1.5">
                                            </path>
                                            <path d="M11.375 10.9501L14.35 10.9501" stroke="currentColor"
                                                stroke-linecap="round" stroke-linejoin="round"
                                                stroke-miterlimit="10" stroke-width="1.5">
                                            </path>
                                            <path d="M0.75 5H17.75" stroke="currentColor"
                                                stroke-linejoin="round" stroke-width="1.5">
                                            </path>
                                        </svg>
                                        صورتحساب ها
